...
public class AlchemyHttpBuilder
{
    ...
    private final Map<String, String> defaultHeaders = new HashMap<>(Constants.DEFAULT_HEADERS);
    ...
    {
        Arguments.checkThat(defaultHeaders).isA(notNull());

        this.defaultHeaders.putAll(defaultHeaders);
        return this;
    }

    public AlchemyHttpBuilder usingDefaultHeader(String key, String value)
    {
