...
final class Step2Impl implements AlchemyRequestSteps.Step2
{
    ...
    @Override
    public AlchemyRequestSteps.Step3 body(String jsonString)
    {
        Arguments.checkThat(jsonString)
    ...
    @Override
    public AlchemyRequestSteps.Step3 body(Object pojo)
    {
        JsonElement jsonBody;
        try
        {
